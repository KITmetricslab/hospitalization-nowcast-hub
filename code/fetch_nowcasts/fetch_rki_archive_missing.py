...
def get_rki_data(url,date):
    ...
    return("")
# Assign url of the raw data:
url = "https://raw.githubusercontent.com/robert-koch-institut/COVID-19-Hospitalisierungen_in_Deutschland/master/Archiv/2021-12-17_Deutschland_adjustierte-COVID-19-Hospitalisierungen.csv"
# assign the current/corresponding date ("YYYY-MM-DD")
date = "2021-12-17"

get_rki_data(url,date)
